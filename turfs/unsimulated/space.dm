...
/turf/unsimulated/space/LevelUpdate()
...
/turf/unsimulated/space/attack_paw(mob/user as mob)
	return attack_hand(user)

/turf/unsimulated/space/attack_hand(mob/user as mob)
	...
	if (ismob(user.pulling))
		...
		M.stop_pulling()
		step(user.pulling, GetDir(user.pulling.loc, src))
		M.start_pulling(t)
	else
		step(user.pulling, GetDir(user.pulling.loc, src))
	return

/turf/unsimulated/space/attackby(obj/item/C as obj, mob/user as mob)
...
/turf/unsimulated/space/Entered(atom/movable/A as mob|obj)
...
/turf/unsimulated/space/proc/Sandbox_Spacemove(atom/movable/A as mob|obj)
	var/cur_x
	var/cur_y
	var/next_x
	var/next_y
